...
Download [spec-workflow-skills.zip](spec-workflow-skills.zip) and extract the four skill directories into your project's `.claude/skills/` folder:
...
Open [How to use these skills.pdf](How%20to%20use%20these%20skills.pdf) for a detailed walkthrough of the full spec lifecycle — from drafting your first spec through implementation and delivery.
